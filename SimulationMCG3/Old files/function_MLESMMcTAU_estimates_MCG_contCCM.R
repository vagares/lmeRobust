...
# the function MLESMMcTAU_estimates_MCG_contCCM. 
...
MLESMMcTAU_estimates_MCG_contCCM=function(nrep=1,n=200,k=4,pe=0,pb=0,px=0,
                                          mec=0,mbc2=0,alphac=1,no=0){
...
MLESMMcTAU_CCM=list()
MLESMMcTAU_CCM[[1]]=MLE
MLESMMcTAU_CCM[[2]]=Sest
MLESMMcTAU_CCM[[3]]=MM
MLESMMcTAU_CCM[[4]]=cTAU
MLESMMcTAU_CCM[[5]]=no_outliers
names(MLESMMcTAU_CCM)=c("MLE","S","MM","cTAU","no_outliers")

return(MLESMMcTAU_CCM)
